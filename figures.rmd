...
Plot waffle plot for Case Study 1 badges

```{r plot.cs1}
waffle(cs1.df[-1], rows = 9, colors = c("#000000", "#af6b0e", "#bab9b8", "#ffb900"), legend_pos = "bottom")
```

Plot waffle plot for Case Study 2 badges
Plot trends for Case Study 2 by year: Line plot and stacked bar chart
Plot badge assignments for Case Study 2 by publisher
